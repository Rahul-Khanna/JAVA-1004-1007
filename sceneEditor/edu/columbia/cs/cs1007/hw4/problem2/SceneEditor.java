...
public class SceneEditor
{
   public static void main(String[] args)
   {
      ...
      stopSignButton.addActionListener(new 
    		  ActionListener()
      {
    	  public void actionPerformed(ActionEvent event)
    	  {
    		  scene.add(new StopSign(scene.getXStopSign(scene.getWidth()),scene.getYStopSign(scene.getHeight()),50));
